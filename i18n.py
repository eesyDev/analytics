locales = {
    "RU": {
        ...
        # competitor.py
        "🔍 Competitor Page Analysis": "🔍 Анализ страниц конкурентов",
        "Paste your page URL first, then competitor URLs — one per line. The tool crawls each page and compares on-page SEO signals.": "Вставьте сначала URL вашей страницы, потом конкурентов — по одному на строку. Инструмент обходит каждую страницу и сравнивает on-page сигналы.",
        "URLs to analyze (your site first)": "URLs для анализа (ваш сайт первым)",
        "🔎 Analyze pages": "🔎 Анализировать страницы",
        "Enter at least one valid URL starting with http:// or https://": "Введите хотя бы один URL начиная с http:// или https://",
        "Max 8 URLs per analysis to stay polite to servers.": "Максимум 8 URL за раз.",
        "Crawling pages…": "Обходим страницы…",
        "Some pages couldn't be crawled (Cloudflare / timeout):": "Некоторые страницы недоступны (Cloudflare / таймаут):",
        "No pages were successfully crawled.": "Ни одна страница не была успешно обработана.",
        "📡 SEO Radar — your site vs competitors": "📡 SEO Радар — ваш сайт vs конкуренты",
        "📊 Page-by-page breakdown": "📊 Детальное сравнение страниц",
        "⚠️ Issues on your page": "⚠️ Проблемы на вашей странице",
        "Missing title tag": "Нет тега Title",
        "Title too long ({n} chars) — Google truncates above ~60": "Title слишком длинный ({n} симв.) — Google обрезает после ~60",
        "Title too short ({n} chars) — aim for 50–60": "Title слишком короткий ({n} симв.) — оптимально 50–60",
        "Missing meta description": "Нет Meta Description",
        "Meta description too long ({n} chars) — truncated in SERPs": "Meta Description слишком длинный ({n} симв.) — обрезается в выдаче",
        "Meta description very short ({n} chars) — aim for 140–160": "Meta Description слишком короткий ({n} симв.) — оптимально 140–160",
        "No H1 tag — critical for on-page SEO": "Нет тега H1 — критично для SEO",
        "{n} H1 tags found — use exactly one H1 per page": "Найдено {n} тегов H1 — должен быть ровно один",
        "{n}/{t} images missing alt text — hurts accessibility and image SEO": "{n}/{t} изображений без alt — вредит доступности и SEO изображений",
        "No schema markup — competitors with schema get rich results in SERPs": "Нет Schema разметки — конкуренты с Schema получают расширенные сниппеты",
        "Content is thin — {mine:,} words vs competitor avg {avg:,}": "Мало контента — {mine:,} слов vs средний конкурент {avg:,}",
        "No major on-page issues detected on your site.": "Серьёзных on-page проблем не обнаружено.",
        "🧩 Keyword Gap — competitor titles & H1s vs yours": "🧩 Keyword Gap — заголовки конкурентов vs ваши",
        "Words that appear in competitor titles/H1s but NOT on your page. These may be signals Google uses to understand topic relevance.": "Слова из заголовков конкурентов, которых нет на вашей странице. Это сигналы тематической релевантности для Google.",
        "Keywords in competitor titles/H1s missing from your page": "Ключевые слова из заголовков конкурентов, которых нет у вас",
        "No keyword gaps detected — your title and H1 cover all competitor terms.": "Keyword gap не обнаружен — ваши заголовки охватывают все слова конкурентов.",
