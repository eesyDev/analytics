...
def render(intent_summary, comm_imp_pct):
    st.markdown('<div class="section-header">🎯 Search Intent Distribution</div>',
    ...
    if comm_imp_pct < 30:
        st.markdown(
            ...
            "The SEO strategy is optimised for awareness, not purchase intent.</div>",
            unsafe_allow_html=True,
        )
